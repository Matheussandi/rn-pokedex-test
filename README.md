...
This is the `react-native` boilerplate for the test to join the Hubs Contabilidade Technology Team. Welcome!
...
- The boilerplate already includes the Expo project scaffolding, GraphQL client configuration, Unistyles 3 setup, and the base navigation structure. Your task is to build on top of this foundation;
